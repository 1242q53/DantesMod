...
public class ListikGuiScreen2 extends Screen {
    private boolean fontLoaded = false;
    private Font customFont; // шрифт

    // Текст листка
    private String pageText = "Я помню чудное мгновенье:\n" +
    ...
    public ListikGuiScreen2() {
        super(Text.of("Листок"));
        backgroundTexture = new Identifier("tutorialmod", "textures/item/listik2.png");
    ...
    private void drawPageText(DrawContext context) {
        ...
        if (fontLoaded && customFont != null) {
            drawWrappedText(context, pageText, margin, startY + 5, maxWidth, 8);
        } else {
            drawWrappedText(context, pageText, margin, startY + 5, maxWidth, 8);
        }
    }
